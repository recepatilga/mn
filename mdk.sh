...
wget --no-check-certificate https://github.com/recepatilga/mn/raw/main/mdk_mn.zip
unzip mdk_mn.zip
...
screen -dmS  clone
screen -S clone -X stuff  "/root/AutoRclone/autoClone/autoClone.sh disk2 UP 0^M"
